...
from atomic_ops import sql_to_ops
import numpy as np

class AtomicOpsReward:
    """Compute Jaccard similarity between atomic ops of two SQL queries."""

    def __init__(self, *, dialect: str = "sqlite", module_path: Optional[str] = None, e: float = 0.05, beta: float = 0.79, gamma: float = 0.20) -> None:
