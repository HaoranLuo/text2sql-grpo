...
scp -o BatchMode=yes -o StrictHostKeyChecking=accept-new -o ConnectTimeout=45 \
    -J ASUS@6.tcp.cpolar.cn:10444 -i ~/.ssh/id_ed25519 "$SRC" "$DST"
echo "scp exit=$?"

H="ssh -o BatchMode=yes -o StrictHostKeyChecking=accept-new -o ConnectTimeout=45 -o ServerAliveInterval=20 -o ServerAliveCountMax=5 -J ASUS@6.tcp.cpolar.cn:10444 -i ~/.ssh/id_ed25519 jiahuiwang24@login.hpc.xjtlu.edu.cn"
