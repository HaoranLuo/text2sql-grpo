...
Host gf-bastion
  ...
  Port 14646                      # ★当前有效端口（2026-08-14 cpolar 再漂移，10889→14646；公告板自动恢复机制已闭环）
  User ASUS
...
| cpolar 地址/端口漂移（漂移史 10444→11220→10889→**14646**） | 公告板机制（Gist `94fb05cee1ed4fe1b0b9edfbb3d718e2`）2026-08-14 首次实战闭环：堡垒机 AI 推送新端口 → 本地读公告板更新 config；TUNNEL_PORT_URL 环境变量已配，ssh_hpc_auto.ps1 支持断线自动恢复 |
